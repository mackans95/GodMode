...
This mod is heavily inspired by `aedenthorn` and his `Regeneration` mod: https://www.nexusmods.com/mytimeatsandrock/mods/8
...
- Download the `GodMode.dll` file from the [latest release](https://github.com/mackans95/GodMode/releases) and copy it into the `BepInEx/plugins/` folder inside your game folder.
...
## Configuration (file gets created at `BepInEx/config/MarGus.Godmode.cfg` after launching the game)
